...
python main.py \
    ...
    --img_emb_path '../data/embedding/inception_v3_pretrained/data/img_emb-dim=30-lr_img_emb=10.0-thr_img_emb=0.05-max_iter_img_emb=10000-k=10.txt' \
    --emb_set_dir 'proj_embedding' \
    --dim 30 \
    --k 10 
