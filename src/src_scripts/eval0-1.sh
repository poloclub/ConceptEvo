...
for label in 801 273 268 315 406 592 400 555 622 481 85 712 638 553 944 159 371 758 384 280 694 762 663 975 972 494
do
    ...
    do
        echo "Eval Vgg16 5->21 label=$label gpu=$gpu ratio=$ratio"
        python main.py \
            --gpu $gpu \
